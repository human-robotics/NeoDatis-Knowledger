// $ANTLR 2.7.5 (20050128): "query.g" -> "QueryLexer.java"$
...
public class QueryLexer extends antlr.CharScanner implements DialogyQueryParserTokenTypes, TokenStream
 {
...
public QueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("where", this), new Integer(5));
	literals.put(new ANTLRHashString("not", this), new Integer(15));
	literals.put(new ANTLRHashString("or", this), new Integer(7));
	literals.put(new ANTLRHashString("is", this), new Integer(12));
...
tryAgain:
	...
	public final void mLCURLY_BRACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LCURLY_BRACE;
		int _saveIndex;
	...
	public final void mRCURLY_BRACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = RCURLY_BRACE;
		int _saveIndex;
