// $ANTLR 2.7.5 (20050128): "grammar/query/query.g" -> "KnowledgerQueryParser.java"$

package org.neodatis.knowledger.parser.query;
...
*/
public class KnowledgerQueryParser extends antlr.LLkParser       implements KnowledgerQueryParserTokenTypes
 {
...
protected KnowledgerQueryParser(TokenBuffer tokenBuf, int k) {
  super(tokenBuf,k);
  tokenNames = _tokenNames;
}

public KnowledgerQueryParser(TokenBuffer tokenBuf) {
  this(tokenBuf,1);
}

protected KnowledgerQueryParser(TokenStream lexer, int k) {
  super(lexer,k);
  tokenNames = _tokenNames;
}

public KnowledgerQueryParser(TokenStream lexer) {
  this(lexer,1);
}

public KnowledgerQueryParser(ParserSharedInputState state) {
  super(state,1);
  tokenNames = _tokenNames;
}
