/* 
 * $RCSfile: YourInteractionManager.java,v $
 * Tag : $Name:  $
 * $Revision: 1.1 $
 * $Author: osmadja $
...
public class YourInteractionManager extends KnowledgerInteractionManager {
    ...
    public long centerOn() {
        try {
            Concept root = getPersistentManager().getConceptFromName("Sistemas de Hipermidia Adaptativa");
            return root.getId();
        } catch (Exception e) {
